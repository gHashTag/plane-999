        ...
        <>
          <div className="flex h-full w-full">
            ...
            {cycleId && !isSidebarCollapsed && (
              <div
                  className="fixed md:relative inset-y-0 z-20 right-0 flex h-full w-[280px] sm:w-[24rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-l border-custom-border-100 bg-custom-sidebar-background-100 px-6 py-3.5 duration-300 vertical-scrollbar scrollbar-sm"
                style={{
                  boxShadow:
