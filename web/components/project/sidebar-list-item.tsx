            ...
            >
              ...
              <Tooltip tooltipContent={`${project.name}`} position="right" className="ml-2" disabled={!isCollapsed}>
                ...
                >
                  ...
                  {!isCollapsed && (
                    <ChevronDown
                      className={cn(
                        "md:hidden h-4 w-4 flex-shrink-0 mb-0.5 text-custom-sidebar-text-400 duration-300 md:group-hover:block",
                        {
                          "rotate-180": open,
                          block: isMenuActive,
                        }
              ...
              {!isCollapsed && (
                <CustomMenu
                  ...
                  className={cn("md:hidden flex-shrink-0 md:group-hover:block", {
                    "!block": isMenuActive,
                  })}
