    ...
    <div className="h-full w-full bg-onboarding-gradient-100">
      <div className="flex items-center justify-between px-8 pb-4 sm:px-16 sm:py-5 lg:px-28 ">
        <div className="flex items-center gap-x-2 py-10">
          <Image src={BluePlaneLogoWithoutText} height={30} width={30} alt="DAO 999 NFT Logo" className="mr-2" />
          <span className="text-2xl font-semibold sm:text-3xl">DAO 999 NFT</span>
        </div>
      </div>
